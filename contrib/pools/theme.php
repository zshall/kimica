...
class PoolsTheme extends Themelet {
	...
	public function list_pools(Page $page, $pools, $pageNumber, $totalPages) {
		...
		foreach($pools as $pool) {
			...
			$user_link = '<a href="'.make_link("account/profile/".url_escape($pool['user_name'])).'">'.html_escape($pool['user_name'])."</a>";
	...
	public function show_history($histories, $pageNumber, $totalPages) {
		...
		foreach($histories as $history) {
			...
			$user_link = "<a href='".make_link("account/profile/".url_escape($history['user_name']))."'>".html_escape($history['user_name'])."</a>";

...
public function displayComments($comments, $journalID, $pageNumber, $totalPages){
	...
	$user_link = "<a href='".make_link("user/".$comment['user_name'])."'>".$comment['user_name']."</a>";
...
public function displayAllJournals($journals, $pageNumber, $totalPages){
	...
	foreach($journals as $journal) {
		...
		$user_link = "<a href='".make_link("user/".$journal['user_name'])."'>".$journal['user_name']."</a>";
...
public function sidebar_profile($info){
	...
	$user_link = "<a href='".make_link("user/".$info['user'])."'>".$info['user']."</a>";
